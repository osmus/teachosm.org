...
2. Under your usernmae, select 'New Project' <img src="/img/create_a_project.gif" />

3. You will now see the job creation interface: <img src="/img/osmtm-new.png" />
