...
##Assigning the work
Assigning the work to your group can be done in a number of ways and it is entirely a personal choice.  For instance, work can be assigned as a quota of infrastructure to trace, or, one can assign designated cells to each student, or, a combination of both of these methods.  
